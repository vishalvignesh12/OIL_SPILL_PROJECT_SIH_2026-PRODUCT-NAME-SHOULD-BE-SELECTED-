  ...
  return (
    <header className="h-16 bg-surface-container-lowest border-b border-outline-variant flex justify-between items-center px-6 z-30 shrink-0 sticky top-0">
      ...
      <div className="flex items-center gap-4">
        <h2 className="text-title-lg text-primary font-bold tracking-tight">
          Maritime Intel
        </h2>
        ...
        <div className="flex items-center gap-2 pl-4 border-l border-outline-variant">
          <span 
            ...
            className="cursor-pointer font-label-sm bg-error-container text-on-error-container px-2.5 py-1 rounded font-bold uppercase tracking-wider hover:opacity-90 transition-opacity"
          ...
          <span className="font-label-sm bg-secondary-container text-on-secondary-container px-2 py-0.5 rounded border border-secondary/20 flex items-center gap-1.5 font-semibold">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative hidden md:block w-72">
          ...
          <input
            ...
            placeholder="Search vessels, MMSI, slick coords..."
        ...
        <button
          ...
          className="relative w-9 h-9 rounded flex items-center justify-center text-on-surface-variant hover:bg-surface-container-high transition-colors"
        ...
        <div 
          ...
          className="flex items-center gap-2.5 pl-3 border-l border-outline-variant cursor-pointer hover:opacity-80 transition-opacity"
